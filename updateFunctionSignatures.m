function updateFunctionSignatures(~)
    ...
    try
        ...
        %% ---------- Option: sd book|hist|files (default show) -----------
        paramModuleShow = struct();
        paramModuleShow.name = "module";
        paramModuleShow.kind = "ordered";
        paramModuleShow.type = {"choices={'book','hist','files'}"};
